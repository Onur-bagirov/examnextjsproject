...
export default function BlogPage() {
    ...
    const reviews = [
        {
            ...
            rating: 5,
            image: "/Image/Burger1.jpg",
            text: "My all time favorite. I'm very much happy having burger. We r friends visited this restaurant."
        },
        {
            id: 2,
            name: "Denial Dina",
            position: "CEO, Lion Company",
            rating: 5,
            image: "/Image/Burger2.jpg",
            text: "My all time favorite. I'm very much happy having burger. We r friends visited this restaurant."
        }
    ...
    const nextReviewSlide = () => {
        setCurrentReviewSlide((prev) => (prev === reviews.length ? 1 : prev + 1));
    };

    const prevReviewSlide = () => {
        setCurrentReviewSlide((prev) => (prev === 1 ? reviews.length : prev - 1));
    };
